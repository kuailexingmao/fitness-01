...
<html>
  ...
  <body>
  <h2>修改客户资料</h2>
    <form action="<%=request.getContextPath() %>/user/updateUser.do" method="post">
    	<table>
    		<tr>
    			<td>客户名称:</td>
    			<td><input type="text" id="uname" name="uname" value="${user.uname}"/>
    		...
    		<tr>
    			<td>客户身份证号:</td>
    			<td><input type="text" id="certifyno" name="certifyno" value="${user.certifyno}"/></td>
    		</tr>
    		<tr>
    			<td>联系方式:</td>
    		...
    		<tr>
    			<td>开户时间:</td>
    			<td><input type="text" id="opentime" name="time" value="${opentime}" onclick="WdatePicker()" class="Wdate"/></td>
    		</tr>
			<tr>
				<td colspan="2">
